...
import 'dual_camera_recorder_platform.dart';
import 'events.dart';
import 'messages.g.dart';

/// Default [DualCameraRecorderPlatform] implementation backed by the Pigeon
...
class PigeonDualCameraRecorder extends DualCameraRecorderPlatform
    implements DualCameraFlutterApi {
  PigeonDualCameraRecorder({DualCameraHostApi? hostApi})
