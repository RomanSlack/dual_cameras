Pod::Spec.new do |s|
  s.name             = 'dual_camera_recorder_ios'
  s.version          = '0.1.0'
  s.summary          = 'iOS implementation of dual_camera_recorder.'
  s.description      = <<-DESC
...
GPU (Metal) into a single video/photo via AVCaptureMultiCamSession.
                       DESC
  s.homepage         = 'https://github.com/RomanSlack/dual_camera_recorder_flutter'
